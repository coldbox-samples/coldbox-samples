		...
		<li>
			<cfif body neq "">
				...
				<div id="#tmpID#" class="reader_panel" style="display: none;">
					...
					<cfif url neq "">
					<img src="images/web_icon.gif" align="absmiddle" border="0">&nbsp;<a href="#url#" target="_blank">Open Article</a>&nbsp;
					</cfif>
					...
					<!--- Content --->
					<div class="reader_content">#body#
					<br><br>
					<img src="images/orange_arrows.gif" border=0 align="absmiddle"><a href="#url#" target="_blank">Read More...</a>
					</div>
				</div><br>

			<cfelse>
				<b>#title#</b>
				<cfif url neq "">(<a href="#url#" target="_blank">Link</a>)</cfif>
			</cfif>
		</li>
	</cfloop>
</ul>
