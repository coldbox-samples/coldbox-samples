...
<cfcomponent extends="coldbox.system.Coldbox" output="false">
	...
	<cfset this.mappings["/ormexample"] = getDirectoryFromPath(getCurrentTemplatePath())>

	<cfset this.ormenabled = true>
	<cfset this.ormsettings={datasource="cfbookclub", cfclocation="./model", dbcreate="update", dialect="Derby", autorebuild=true}>
