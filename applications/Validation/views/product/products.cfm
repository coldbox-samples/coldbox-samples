	...
	<table class="zebra-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="#event.buildLink('product/edit')#?product_id=#product.getId()#">Edit</a></td>
			</tr>
			</cfloop>
		</tbody>
	</table>

	<p align="right"><a href="#event.buildLink('product/edit')#"><button class="btn primary">Add New Product</button></a></p>
