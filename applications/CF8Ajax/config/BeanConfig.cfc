<cfcomponent name="LightBaseBeanConfig" extends="coldbox.system.ioc.lightwire.BaseConfigObject" hint="A LightWire configuration bean.">
<!---
...
--->
	...
	<cffunction name="init" output="false" returntype="any" hint="I initialize the config bean.">
		<cfscript>
			...
			// Item Service
			addSingleton("#cfcModelRoot#.model.ArtService","ArtService");
			...
			addSingleton("#cfcModelRoot#.model.GalleryService","GalleryService");
			addConstructorProperty("GalleryService", "dsn", dsn);
			addConstructorProperty("GalleryService", "ColdboxFactory", ColdboxFactory);


			addSingleton("#cfcModelRoot#.model.OrderService","OrderService");
