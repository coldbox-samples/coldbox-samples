...
<cfcomponent extends="coldbox.system.Coldbox" output="false">
	...
	<cfset this.name = "SimpleBlog" & hash(getCurrentTemplatePath())> 
	...
	<!--- ORM Settings --->
	<cfset this.mappings["/model"] = GetDirectoryFromPath( GetBaseTemplatePath() ) & "model\">
	<cfset this.ormEnabled = true>
	<cfset this.datasource = "simpleblog">
