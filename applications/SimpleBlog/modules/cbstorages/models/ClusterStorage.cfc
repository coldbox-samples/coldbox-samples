...
----------------------------------------------------------------------->
<cfcomponent hint="Cluster Storage plugin. It provides the user with a mechanism for permanent data storage using the Cluster scope. This plugin creates a special variable in cluster scope that correctly identifies the coldbox app."
			 output="false"
			 singleton>
