...
<cffunction name="number1kSeparator" output="false" access="public" returntype="string" hint="Inserts thousand seperators into a number">
  ...
  <cfscript>
    ...
    integer = REReplace(Reverse(integer), "([0-9][0-9][0-9])", "\1#arguments.seperator#", "ALL");
...
<cffunction name="numberSuffix" output="false" access="public" returntype="string" hint="Attaches an oral suffix (st,nd,rd,th) to a number">
  <cfargument name="number" required="yes" type="numeric" hint="Integer">
  <cfargument name="seperator" default="," type="string" hint="Seperator character">
  <cfscript>
    var suffix = '';
    ...
    return number1kSeparator(arguments.number,arguments.seperator) & suffix;
  </cfscript>
</cffunction>

<cffunction name="numberUnit" output="false" access="public" returntype="string" hint="Converts a number into a rounded computer unit">
  ...
  <cfscript>
    ...
    /* return final result */
    return number1kSeparator(result,arguments.seperator) & unitString;
  </cfscript>
</cffunction>

<cffunction name="paraAbrupt" output="false" access="public" returntype="string" hint="Cuts a string to a specific length and fills there rest with ...">
