<cfoutput>
<div class="pageStats">
Page 1 of 1 - There was a total of #ArrayLen(rc.flickrdata.items)# results
</div>
<div class="feedImg">
...
Last Search Result Revision: #TimeFormat(rc.flickrdata.dateupdated,'h:mm tt')#, #DateFormat(rc.flickrdata.dateupdated,'d mmm. yyyy')#
</div>
</cfoutput>
