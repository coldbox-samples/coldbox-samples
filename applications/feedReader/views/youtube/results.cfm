...
Last Search Result Revision: #getPlugin("i18n").datetimeLocaleFormat(rc.ytdata.dateupdated,'long')#
</div>
</cfoutput>
...
<cfoutput>
	...
	<div style="padding-bottom:4px;"><a href="#rc.ytdata.items[rc.i].comments.url#">#getPlugin(plugin="Utilities",customPlugin=true).oneKGrouping(rc.ytdata.items[rc.i].comments.count)# comments</a></div>
	</cfif>
	<div class="itemstat">
		Id: #rc.ytdata.items[rc.i].id# - 
		<!--- TODO: Potential bug in Open BlueDragon? ---><cfif not StructKeyExists(server,'bluedragon')>Last updated: #getPlugin("i18n").datetimeLocaleFormat(rc.ytdata.items[rc.i].dateupdated,'long')# - </cfif>
